...
SEIR=fit_model(pathSEIR1,incidence="incidence_ndss_obs",start_date="2002-01-01",end_date="2013-12-31")
...
Laneri=Laneri+ theme(plot.margin=unit(c(1,1,0.5,0.5), "cm"))+ ggtitle('Laneri') +theme(plot.title=element_text( face="bold", size=80,hjust =0.1))+ ylim(0,90) +scale_x_date(date_breaks=("1 year") ,date_labels = "%Y")
Pandey=Pandey+ theme(plot.margin=unit(c(1,1,0.5,0.5), "cm"))+ ggtitle('Pandey') +theme(plot.title=element_text( face="bold", size=80,hjust =0.1))+ ylim(0,90) +scale_x_date(date_breaks=("1 year") ,date_labels = "%Y")
SEIR2=SEIR2+ theme(plot.margin=unit(c(1,1,0.5,0.5), "cm"))+ ggtitle('SEIR2') +theme(plot.title=element_text( face="bold", size=80,hjust =0.1))+ ylim(0,90) +scale_x_date(date_breaks=("1 year") ,date_labels = "%Y")
SEIR2_psi=SEIR2_psi+ theme(plot.margin=unit(c(1,1,0.5,0.5), "cm"))+ ggtitle('SEIR2 psi') +theme(plot.title=element_text( face="bold", size=80,hjust =0.1))+ ylim(0,90) +scale_x_date(date_breaks=("1 year") ,date_labels = "%Y")
SEIAR=SEIAR+ theme(plot.margin=unit(c(1,1,0.5,0.5), "cm"))+ ggtitle('SEIAR') +theme(plot.title=element_text( face="bold", size=80,hjust =0.1))+ ylim(0,90) +scale_x_date(date_breaks=("1 year") ,date_labels = "%Y")
