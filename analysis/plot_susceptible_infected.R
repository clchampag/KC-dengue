...
#Graphical settings
SEIR2_I1b=SEIR2_I1+ ylim(0,1000)+theme(plot.margin=unit(c(1,1,0.5,0.5), "cm"))+ ggtitle(expression(H[I1]+H[I21])) +theme(plot.title=element_text( face="bold", size=80,hjust =0.1))
SEIR2_I2b=SEIR2_I2+ ylim(0,1000)+ theme(plot.margin=unit(c(1,1,0.5,0.5), "cm"))+ ggtitle(expression(H[I2]+H[I12])) +theme(plot.title=element_text( face="bold", size=80,hjust =0.1))
SEIR2_S1b=SEIR2_S1+ ylim(0.1,0.35)+theme(plot.margin=unit(c(1,1,0.5,0.5), "cm"))+ ggtitle(expression(H[S1]/N)) +theme(plot.title=element_text( face="bold", size=80,hjust =0.1))
SEIR2_S2b=SEIR2_S2+ ylim(0.1,0.35)+theme(plot.margin=unit(c(1,1,0.5,0.5), "cm"))+ ggtitle(expression(H[S2]/N)) +theme(plot.title=element_text( face="bold", size=80,hjust =0.1))
SEIR2_Sb=SEIR2_S+ ylim(0.1,0.35)+theme(plot.margin=unit(c(1,1,0.5,0.5), "cm"))+ ggtitle(expression(H[S]/N)) +theme(plot.title=element_text( face="bold", size=80,hjust =0.1))
SEIR_Sb=SEIR_S+ ylim(0.3,0.5)+theme(plot.margin=unit(c(1,1,0.5,0.5), "cm"))+ ggtitle(expression((SEIR) ~~H[S]/N)) +theme(plot.title=element_text( face="bold", size=80,hjust =0.1))
